...
public class AmethystBulletRenderer extends EntityRenderer<BeestaniteBulletEntity> {
	private static final Identifier TEXTURE = new Identifier(Buddinghoney.MOD_ID, "textures/entity/amethyst_bullet_entity.png");

	private static final RenderLayer LAYER = RenderLayer.getEntityTranslucent(TEXTURE);

	private final AmethystBulletModel model;


	public AmethystBulletRenderer(EntityRendererFactory.Context ctx) {
		super(ctx);
		this.model = new AmethystBulletModel(ctx.getPart(ModModelLayers.AMETHYST_BULLET_LAYER));
	}
