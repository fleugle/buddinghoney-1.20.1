...
public class AmethystCogswordItemModel extends GeoModel<CogswordItem> {
    ...
    private static final Identifier texture = new Identifier(Buddinghoney.MOD_ID, "textures/item/a_cogsword.png");
